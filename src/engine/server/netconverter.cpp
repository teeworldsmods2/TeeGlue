...
CNetConverter::CNetConverter(IServer *pServer, class CConfig *pConfig) : m_pServer(pServer),
                                                                         m_pConfig(pConfig)
{
    m_GameFlags = 0;
    ResetSnapItemsEx();
...
int CNetConverter::DeepMsgConvert6(CMsgPacker *pMsg, int Flags, int ToClientID)
{
    ...
    case NETMSGTYPE_SV_TEAM:
    {
        ...
        {
        case STR_TEAM_GAME:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' joined the game"), Server()->ClientName(ClientID));
            break;
        case STR_TEAM_RED:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' joined the red team"), Server()->ClientName(ClientID));
            break;
        case STR_TEAM_BLUE:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' joined the blue team"), Server()->ClientName(ClientID));
            break;
        case STR_TEAM_SPECTATORS:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' joined the spectators"), Server()->ClientName(ClientID));
            break;
        }
        protocol6::CNetMsg_Sv_Chat Chat;
        Chat.m_ClientID = -1;
    ...
    case NETMSGTYPE_SV_CLIENTINFO:
    {
        ...
        {
        case STR_TEAM_GAME:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' entered and joined the game"), pName);
            break;
        case STR_TEAM_RED:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' entered and joined the red team"), pName);
            break;
        case STR_TEAM_BLUE:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' entered and joined the blue team"), pName);
            break;
        case STR_TEAM_SPECTATORS:
            str_format(aBuf, sizeof(aBuf), Localize(TempCode, "'%s' entered and joined the spectators"), pName);
            break;
        }
...
int CNetConverter::DeepGameMsgConvert6(CMsgPacker *pMsg, int Flags, int ToClientID)
{
    ...
    case GAMEMSG_TEAM_ALL:
    {
        ...
        {
        case STR_TEAM_GAME:
            pMsg = Localize(TempCode, "All players were moved to the game");
            break;
        case STR_TEAM_RED:
            pMsg = Localize(TempCode, "All players were moved to the red team");
            break;
        case STR_TEAM_BLUE:
            pMsg = Localize(TempCode, "All players were moved to the blue team");
            break;
        case STR_TEAM_SPECTATORS:
            pMsg = Localize(TempCode, "All players were moved to the spectators");
            break;
        }
    ...
    case GAMEMSG_TEAM_BALANCE_VICTIM:
    {
        ...
        {
        case STR_TEAM_RED:
            pMsg = Localize(TempCode, "You were moved to the red team due to team balancing");
            break;
        case STR_TEAM_BLUE:
            pMsg = Localize(TempCode, "You were moved to the blue team due to team balancing");
            break;
        }
...
static int SystemMsg7To6(int Msg)
{
    switch (Msg)
    {
    case NETMSG_MAP_DATA:
        return protocol6::NETMSG_MAP_DATA;
    case NETMSG_CON_READY:
        return protocol6::NETMSG_CON_READY;
    case NETMSG_SNAP:
        return protocol6::NETMSG_SNAP;
    case NETMSG_SNAPEMPTY:
        return protocol6::NETMSG_SNAPEMPTY;
    case NETMSG_SNAPSINGLE:
        return protocol6::NETMSG_SNAPSINGLE;
    case NETMSG_SNAPSMALL:
        return protocol6::NETMSG_SNAPSMALL;
    case NETMSG_INPUTTIMING:
        return protocol6::NETMSG_INPUTTIMING;
    case NETMSG_RCON_LINE:
        return protocol6::NETMSG_RCON_LINE;
    case NETMSG_RCON_CMD_ADD:
        return protocol6::NETMSG_RCON_CMD_ADD;
    case NETMSG_RCON_CMD_REM:
        return protocol6::NETMSG_RCON_CMD_REM;
    case NETMSG_PING:
        return protocol6::NETMSG_PING;
    case NETMSG_PING_REPLY:
        return protocol6::NETMSG_PING_REPLY;
    }
    return -1;
}
